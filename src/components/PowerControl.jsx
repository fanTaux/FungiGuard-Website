        ...
        <section className="glass-card rounded-xl p-md flex flex-col h-full justify-between relative overflow-hidden">
            ...
            <div className="flex items-center justify-between mb-8 relative z-10">
                <div>
                    ...
                    <p className="text-xs text-on-surface-variant">Kendali Utama Sistem SleepWell</p>
                </div>
                <div className={`px-3 py-1 rounded-full text-xs font-bold border ${state.system ? 'bg-[#4ade80]/10 text-[#4ade80] border-[#4ade80]/30' : 'bg-surface-variant text-on-surface-variant border-transparent'}`}>
            ...
            <div className="flex-1 flex flex-col items-center justify-center relative z-10 py-4">
                ...
                >
                    <span className={`material-symbols-outlined text-5xl transition-colors duration-300 ${state.system ? 'text-white' : 'text-gray-500'}`}>
                        power_settings_new
                    </span>
                    ...
                    {state.system && (
                        <>
                            ...
                            <div className="absolute inset-[-10px] rounded-full border-2 border-[#4ade80] opacity-0 animate-[ping_2.5s_cubic-bezier(0,0,0.2,1)_infinite] delay-300"></div>
                        </>
                    )}
                </button>
                
                <p className="mt-8 text-sm text-center text-on-surface-variant max-w-[200px]">
                    {espIsAlive 
                        ? state.system 
