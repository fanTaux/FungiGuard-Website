        ...
        <div className="max-w-4xl mx-auto space-y-8 pb-12 relative">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm">
                <div className="flex items-center gap-4">
                    <div className="w-16 h-16 bg-[#624633] rounded-3xl flex items-center justify-center text-white shadow-xl">
                        <span className="material-symbols-outlined text-3xl">history</span>
                    </div>
                    <div>
                        <h2 className="font-black text-[#624633] text-2xl tracking-tight uppercase">Scanning History</h2>
                ...
                <div className="flex gap-2">
                    <button 
                        onClick={exportToCSV}
                        className="px-6 py-3 bg-[#f4ebe1] text-[#735d4d] rounded-2xl font-black text-[10px] uppercase tracking-widest flex items-center gap-2 hover:bg-[#735d4d] hover:text-white transition-all shadow-sm active:scale-95"
                    >
                ...
                {scanHistory.length === 0 ? (
                    ...
                    return (
                        <div 
                            ...
                            className="bg-white rounded-[2rem] p-6 border border-gray-100 group hover:shadow-xl hover:border-orange-100 transition-all duration-300 animate-fade-in cursor-pointer"
                        >
                            <div className="flex flex-col md:flex-row md:items-center gap-6">
                                <div className={`w-20 h-20 md:w-24 md:h-24 rounded-3xl flex flex-col items-center justify-center shadow-inner shrink-0 ${scan.riskLevel > 70 ? 'bg-red-50 text-red-600' : scan.riskLevel > 40 ? 'bg-orange-50 text-orange-600' : 'bg-orange-50 text-green-600'}`}>
                                ...
                                <div className="flex-1">
                                    <div className="flex flex-wrap items-center justify-between gap-3 mb-3">
                                        <div className="flex items-center gap-2">
                                            <span className="px-3 py-1 bg-[#624633] text-white text-[9px] font-black rounded-lg uppercase tracking-[0.15em] shadow-sm">{scan.location}</span>
                                    ...
                                    <h3 className="text-sm font-black text-[#624633] mb-1 line-clamp-1">{scan.message}</h3>
                                ...
                                <div className="hidden lg:block shrink-0 px-4">
                                    <div className="w-10 h-10 rounded-full flex items-center justify-center border-2 border-gray-50 text-gray-300 group-hover:bg-[#624633] group-hover:text-white group-hover:border-[#624633] transition-all">
            ...
            {selectedScan && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#624633]/40 backdrop-blur-sm animate-fade-in">
                    <div className="bg-white w-full max-w-lg rounded-[3rem] shadow-2xl overflow-hidden relative animate-bounce-in max-h-[90vh] flex flex-col">
                        ...
                        {/* Modal Header */}
                        <div className="bg-[#624633] p-8 text-white relative">
                            <button 
                        ...
                        <div className="p-8 space-y-8 overflow-y-auto">
                            <div className="flex flex-col items-center">
                                <div className="relative w-48 h-24 overflow-hidden mb-4">
                                    ...
                                    <div 
                                        ...
                                        style={{ 
                                            borderColor: selectedScan.riskLevel > 70 ? '#dc2626' : selectedScan.riskLevel > 40 ? '#f97316' : '#8c7462',
                                ...
                                <div className="text-center">
                                    <p className="text-5xl font-black text-[#624633] mb-1">{selectedScan.riskLevel}%</p>
                            ...
                            <div className="bg-[#f8fafc] p-6 rounded-[2rem] border border-gray-50">
                                ...
                                <p className="text-sm font-black text-[#624633] mb-2">{selectedScan.message}</p>
                                {selectedScan.notes && (
                                    <div className="mt-4 pt-4 border-t border-gray-200">
                                        <h5 className="text-[9px] font-black text-[#8c7462] uppercase tracking-widest mb-2">User Notes</h5>
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                <div className="bg-white border border-gray-100 p-4 rounded-2xl shadow-sm text-center">
                                    ...
                                    <p className="text-sm font-black text-[#624633]">{selectedScan.temperature.toFixed(1)}°C</p>
                                </div>
                                <div className="bg-white border border-gray-100 p-4 rounded-2xl shadow-sm text-center">
                                    ...
                                    <p className="text-sm font-black text-[#624633]">{selectedScan.humidity.toFixed(0)}%</p>
                                </div>
                                <div className="bg-white border border-gray-100 p-4 rounded-2xl shadow-sm text-center">
                                    ...
                                    <p className="text-sm font-black text-[#624633]">{selectedScan.duration}s</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-6 bg-gray-50 flex gap-3">
                            ...
                            <button 
                                onClick={() => setSelectedScan(null)}
                                className="flex-1 py-4 bg-[#624633] text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-lg hover:bg-[#735d4d] transition-all"
                            >
                                Tutup
                            </button>
                        </div>
